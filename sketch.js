...
function setup() {
  ...
  boy = createSprite(200, 430, 20, 50);
  boy.addAnimation("running", boy_running);
  boy.setCollider('circle', 0, 0, 350);
  boy.scale = 1;

  good_test = createSprite(600, height - 95, 20, 30);
  good_test.scale = 3;
  bad_test = createSprite(600, height - 95, 20, 30);
  bad_test.scale = 3;

  invisibleGround = createSprite(50, 100,20,50);
